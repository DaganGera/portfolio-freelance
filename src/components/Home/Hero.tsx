          ...
          >
            <div className="w-[80%] xs:w-full">
              <div className="w-[90%] sm:w-[80%] md:w-[60%]">
                <Paragraph text="I'm Marcben, the builder behind Markow Studios — a Chennai-based freelance studio designing and shipping websites, brand posters, CRM/ERP systems, and WhatsApp &amp; email automations powered by n8n for clients everywhere." />
              </div>
              <div className="mt-3">
