...
function Footer() {
  ...
  const links = [
    {
      title: "email",
      href: "mailto:markowstudios@gmail.com",
    },
    {
      title: "whatsapp",
      href: "https://wa.me/917838350940",
    },
    {
      title: "github",
      href: "https://github.com/DaganGera",
    },
    {
      title: "instagram",
      href: "https://www.instagram.com/markow_studios/",
    },
  ];

  const line1 = "Any questions? Interested";
  const line2 = "in websites, systems, or";
  const line3 = "automations? Let's talk!";
  ...
  return (
    <footer className="mb-[20px]">
      ...
      <motion.div className="mt-3 flex justify-center md:justify-start">
        <p className="text-[12px]">All Rights Reserved &copy; 2026 Markow Studios</p>
      </motion.div>
    </footer>
  );
}
