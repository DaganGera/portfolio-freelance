...
import AboutImage1 from "../../../public/images/general/stock/about-moredetail1.jpg";
import AboutImage2 from "../../../public/images/general/stock/about-moredetail2.jpg";
    ...
    <section className="mt-[5vh]">
      <div className="flex flex-col md:flex-row items-end gap-6 md:pl-[8vw]">
        <div className="w-full flex-1 object-cover overflow-hidden">
          <Image
            src={AboutImage1}
            alt="office chair and computer silhouette against a window"
        ...
        <div className="flex-[1.5]">
          <div className="w-full object-cover overflow-hidden">
            <Image
              src={AboutImage2}
              alt="minimalist desk with a small plant"
              className="w-full h-full object-cover scale-110"
              placeholder="blur"
              ref={image2}
            />
