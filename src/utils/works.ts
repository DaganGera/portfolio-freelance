...
import DeluvPortrait3 from "../../public/images/deluv/portrait3.jpg";
...
const projects = [
  {
    ...
    imagesPortrait: [
      ...
      },
      {
        ...
        alt: "bride in saree and gold jewellery for a consultation photo",
      },
    ],
  },
  {
    ...
    description2: [
      "The salon offers a genuinely wide menu — hair, skin, hands and feet, bridal, men's grooming — and the challenge was presenting all of it without turning the page into a wall of text. I grouped services into browsable cards with just enough detail to help someone pick a treatment, and pushed the exhaustive lists into secondary views.",
    ...
    imagesLandscape: [
      {
        ...
        alt: "Studio11 service cards for hair and hair treatments over salon photography",
      },
    ],
    imagesPortrait: [
      {
      ...
      },
      {
        ...
        alt: "hair service card listing haircuts, colour, and styling",
      },
    ],
  },
  {
    ...
    imagesLandscape: [
      {
        ...
        alt: "EDA-THON event details panel showing date, venue, hours, and status",
      },
    ],
    imagesPortrait: [
      {
